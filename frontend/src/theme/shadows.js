...
const DARK_MODE = paletteDark.grey[500];
...
const createCustomShadow = (color) => {
  ...
  return {
    ...
    primary: `0 8px 16px 0 ${alpha(paletteLight.primary.main, 0.24)}`,
    secondary: `0 8px 16px 0 ${alpha(paletteLight.secondary.main, 0.24)}`,
    info: `0 8px 16px 0 ${alpha(paletteLight.info.main, 0.24)}`,
    success: `0 8px 16px 0 ${alpha(paletteLight.success.main, 0.24)}`,
    warning: `0 8px 16px 0 ${alpha(paletteLight.warning.main, 0.24)}`,
    error: `0 8px 16px 0 ${alpha(paletteLight.error.main, 0.24)}`
  };
};
